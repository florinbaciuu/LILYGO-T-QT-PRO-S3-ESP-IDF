...
#   - python .gitlab/tools/build_apps.py test_apps/format/example -t esp32s3
# - Test
#   - pip install -r .gitlab/requirements/requirement.pytest.txt
#   - pytest test_apps/format/example --target esp32s3
# '''
...
def test_format_example(dut: Dut)-> None:
