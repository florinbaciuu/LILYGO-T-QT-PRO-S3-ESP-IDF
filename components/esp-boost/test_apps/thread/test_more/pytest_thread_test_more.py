...
#   - python .gitlab/tools/build_apps.py test_apps/signals2/example -t esp32s3
# - Test
#   - pip install -r .gitlab/requirements/requirement.pytest.txt
#   - pytest test_apps/signals2/example --target esp32s3
# '''
...
def test_thread_test_more(dut: Dut)-> None:
