...
https://github.com/florinbaciuu/LILYGO-T-DISPLAY-S3-ESP-IDF.git
...
```
git remote add origin https://github.com/florinbaciuu/LILYGO-T-DISPLAY-S3-ESP-IDF.git
git remote add github https://github.com/florinbaciuu/LILYGO-T-DISPLAY-S3-ESP-IDF.git
git remote add gitlab https://github.com/florinbaciuu/LILYGO-T-DISPLAY-S3-ESP-IDF.git
...
```
git clone --recurse-submodules https://github.com/florinbaciuu/LILYGO-T-DISPLAY-S3-ESP-IDF.git
